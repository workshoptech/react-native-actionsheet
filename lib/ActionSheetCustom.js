...
class ActionSheet extends React.Component {
  ...
  _calculateHeight (props) {
    ...
    // Add height to the ActionSheet if iPhoneX.
    // We increase the height and add padding of the Cancel button too.
    if (utils.isIPhoneX) height += 50
  ...
  _createButton (title, index) {
    ...
    const buttonBoxStyle = cancelButtonIndex === index ? [styles.cancelButtonBox, { height: utils.isIPhoneX ? 90 : 50, paddingBottom: utils.isIPhoneX ? 15 : 0 }] : styles.buttonBox
